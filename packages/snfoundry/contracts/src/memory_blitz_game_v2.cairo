...
#[starknet::interface]
pub trait IMemoryBlitzGameV2<TContractState> {
    // Game functions
...
mod MemoryBlitzGameV2 {
    ...
    struct Storage {
        ...
        round_leaderboard_levels: Map<(u32, u32), u32>,
        ...
        historic_leaderboard_levels: Map<u32, u32>,
    ...
    pub struct PlayerStats {
        ...
        pub all_time_highest_level: u32,
    ...
    #[abi(embed_v0)]
    impl MemoryBlitzGameV2 of super::IMemoryBlitzGameV2<ContractState> {
        ...
        fn submit_score(
            ...
            game_session.level_reached = level_reached;
            game_session.sequence_length = sequence_length;
            ...
            if level_reached > round_stats.highest_level {
                round_stats.highest_level = level_reached;
                self.emit(NewHighLevel { player: caller, level: level_reached });
            }
            ...
            if level_reached > all_time_stats.all_time_highest_level {
                all_time_stats.all_time_highest_level = level_reached;
            }
            self.player_all_time_stats.write(caller, all_time_stats);

            // Update leaderboards
            self._update_round_leaderboard(caller, score, level_reached, round);
            self._update_historic_leaderboard(caller, score, level_reached);
        ...
        fn get_current_round_leaderboard(
            ...
            while i < actual_limit {
                ...
                let level_reached = self.round_leaderboard_levels.read((round, i));
        ...
        fn get_historic_leaderboard(self: @ContractState, limit: u32) -> Array<LeaderboardEntry> {
            ...
            while i < actual_limit {
                ...
                let level_reached = self.historic_leaderboard_levels.read(i);
                leaderboard.append(LeaderboardEntry {
                    player,
                    score,
                    level_reached,
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn _update_round_leaderboard(
            ...
            // Find insertion position (sort by score, then by level)
            while i < board_size {
                let existing_score = self.round_leaderboard_scores.read((round, i));
                let existing_level = self.round_leaderboard_levels.read((round, i));

                if score > existing_score || (score == existing_score && level_reached > existing_level) {
                    position = i;
                    break;
                }
                i += 1;
            ...
            if position < max_size {
                ...
                while j > position {
                    ...
                    let prev_level = self.round_leaderboard_levels.read((round, j - 1));
                ...
                self.round_leaderboard_levels.write((round, position), level_reached);
        ...
        fn _update_historic_leaderboard(
            ...
            while i < board_size {
                ...
                let existing_level = self.historic_leaderboard_levels.read(i);
