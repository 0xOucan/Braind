...
pub trait IMemoryBlitzGame<TContractState> {
    ...
    fn get_player_highest_level(self: @TContractState, player: ContractAddress) -> u32;
...
mod MemoryBlitzGame {
    ...
    fn constructor(
        ...
        // Set default game fees (same as other games)
    ...
    #[abi(embed_v0)]
    impl MemoryBlitzGame of super::IMemoryBlitzGame<ContractState> {
        ...
        fn submit_score(
            ...
            if sequence_length > player_stats.longest_sequence {
                player_stats.longest_sequence = sequence_length;
            }
        ...
        fn get_player_highest_level(self: @ContractState, player: ContractAddress) -> u32 {
